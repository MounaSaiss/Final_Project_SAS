                ...
                case 3:
                        ...
                        do
                        {
                                ...
                                case 3:
                                        ...
                                        scanf("%d",&ch);
                                        switch(ch){
                                                case 1:trieAlpaha(PRODUIT);
                                                        break;
                                                case 2: triCroi(PRODUIT);
                                                        break;
                                                case 3:triDEcroi(PRODUIT);
                                                        break;
...
void depotArgent(client CLIENTINFO[])
{
        ...
        printf("Votre nauveau Solde est :%f\n", CLIENTINFO[nbrClient-1].sold);
}
